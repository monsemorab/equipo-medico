...
export class EditEquipoComponent implements OnInit, OnDestroy {
    ...
    // subscriptions
    private subscriptionGetAllTipos: ISubscription;
    private subscriptionGetAllModelos: ISubscription;
    private subscriptionGetAllRepresentantes: ISubscription;
    private subscriptionGetAllUbicaciones: ISubscription;
    ...
    ngOnDestroy() {
        if (this.subscriptionGetAllTipos != null) {
            this.subscriptionGetAllTipos.unsubscribe();
        }
        if (this.subscriptionGetAllModelos != null) {
            this.subscriptionGetAllModelos.unsubscribe();
        }
        if (this.subscriptionGetAllRepresentantes != null) {
            this.subscriptionGetAllRepresentantes.unsubscribe();
        }
        if (this.subscriptionGetAllUbicaciones != null) {
            this.subscriptionGetAllUbicaciones.unsubscribe();
        }
     ...
     */
    getAllTipos(): void {
        this.subscriptionGetAllTipos = this.equipoService.getTipoEquipos().subscribe(
            tipos => {
                this.tipos = tipos;
            },
            error => {
     ...
     */
    getAllModelos(): void {
        this.subscriptionGetAllModelos = this.equipoService.getModeloEquipos().subscribe(
            modelos => {
    ...
    getAllUbicaciones(): void {
        this.subscriptionGetAllUbicaciones = this.equipoService.getAllUbicaciones().subscribe(
            ubicaciones => {
     ...
     * @param {number} id
     */
    getUbicaciónById(id: number): void {
    ...
    saveEquipo(equipo: Equipo): void {
        this.subscriptionSaveEquipo = this.equipoService.editarEquipo(equipo).subscribe(
            equipo => {
                this.equipo = equipo;
                this.goBack();
            },
