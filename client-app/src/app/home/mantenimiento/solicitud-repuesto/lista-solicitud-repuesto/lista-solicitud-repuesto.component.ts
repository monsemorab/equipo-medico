...
@Component({
  selector: 'app-lista-solicitud-repuesto',
  templateUrl: './lista-solicitud-repuesto.component.html',
  styleUrls: ['./lista-solicitud-repuesto.component.css']
})
export class ListaSolicitudRepuestoComponent implements OnInit {
