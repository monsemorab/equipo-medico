...
@Component({
  selector: 'app-edit-solicitud-repuesto',
  templateUrl: './edit-solicitud-repuesto.component.html',
  styleUrls: ['./edit-solicitud-repuesto.component.css']
})
export class EditSolicitudRepuestoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.route.paramMap
      .pipe(
        ...
        this.solicitudRepuesto = new SolicitudRepuesto(solicitud.id, solicitud.codigo, solicitud.repuestos,
  ...
  camposAEditar(solicitud: SolicitudRepuesto) {
    ...
    this.codigoDes = solicitud.codigo;
  ...
  onSaveSolicitudRepuesto(): void {
    this.solicitudRepuesto = new SolicitudRepuesto(this.id, this.codigoDes, this.repuestos, this.fechaSolicitud);
